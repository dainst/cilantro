<template>
    <div class="container">
        <h3 class="is-size-3">Start a new job</h3>
        <div class="tile is-ancestor">
            <div class="tile is-parent">
                <div class="tile is-child box">
                    <p class="title">Retrodigitized Journals</p>
                    <p>
                        Import multiple folders that contain scans of journal issues
                        into iDAI.publications / OJS.
                    </p>
                    <router-link to="ingest-journal"
                                 tag="b-button"
                                 id="start_ingest_journal">
                        Start
                    </router-link>
                </div>
                <div class="tile is-child box">
                ...
                <div class="tile is-child box">
                    ...
                    <router-link to="ingest-archival-material"
                                 tag="b-button"
                                 id="start_ingest_archival_material">
                        Start
                    </router-link>
                </div>
            </div>
