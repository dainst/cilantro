...
class ConvertImageTest(unittest.TestCase):
    ...
    def test_scale_jpg(self):
        ...
        self.assertTrue(os.path.isfile(
            f'{self.resource_dir}/test_29_40.jpg'))
        os.remove(os.path.join(self.resource_dir, 'test_29_40.jpg'))
    ...
    def test_scale_tif(self):
        ...
        scale_image(image_file, self.resource_dir, 30, 40)
        self.assertTrue(os.path.isfile(
            f'{self.resource_dir}/test_24_40.tif'))
        os.remove(os.path.join(self.resource_dir, 'test_24_40.tif'))
